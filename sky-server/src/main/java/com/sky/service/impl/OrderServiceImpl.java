...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public PageResult conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        List<OrderVO> orderVOList=getOrderVO(page);
...
//                    new BigDecimal(0.01));
    ...
    private void checkOutOfRange(String address){
        ...
        String shoppOrdinate = HttpClientUtil.doGet("https://api.map.baidu.com/geocoding/v3/", map);

        JSONObject jsonObject = JSON.parseObject(shoppOrdinate);
